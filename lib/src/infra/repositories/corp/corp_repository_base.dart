...
/// Shared response handling for the corporate repositories.
///
/// The Retail repositories each carry their own private copy of this
/// unwrap-and-map logic; the corporate side keeps one copy here so every
/// corporate repository treats OBDX's two failure shapes identically:
/// a non-200 HTTP status, and a 200 whose body carries
/// `status.message.type: ERROR` (which OBDX uses for business failures).
abstract class CorpRepositoryBase {
